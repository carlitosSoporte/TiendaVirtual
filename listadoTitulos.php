...
<body>
  ...
  $consultaSQL = "select idTitulo,nombre,fechaEstreno,genero,valor,tipoImagen,imagen from titulo";
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100 text-warning bg-dark">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">ID: <strong><?= $fila["idTitulo"] ?></strong>
                  <p class="lead"></p>
                  <p class="card-text">Fecha estreno: <strong><?= $fila["fechaEstreno"] ?></strong>
                  <p class="lead"></p>
                  <p class="card-text">Genero: <strong><?= $fila["genero"] ?></strong>
                  <p class="lead"></p>
                  <p class="card-text">Valor: <strong><?= $fila["valor"] ?></strong>
                  <p class="lead"></p>
                  <p class="text-center">
